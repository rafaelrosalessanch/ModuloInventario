...
oXML.send('');
            ...
            $("#activarfiltro").click(function(){
                ...
                if (document.getElementById('activarfiltro').checked)
                {
                    ...
                    document.getElementById("marcacomponente0").style.height="225px";
                    ...
                    document.getElementById("marcacomponente0").style.height="275px";
                    document.getElementById('iddiv').style.marginTop='-40px';
...
//                document.getElementById("departamentoconsultar").value="Seleccionar";
        ...
        function imprimirlistado(contenidoo){

            history.go(0);
            var url = "../controladores/controladorImprimirTotalTipo.php"; // the script where you handle the form input.
            $.ajax({
                type: "POST",
                url: url,
                data: $("#formulariomodificar").serialize()// serializes the form's elements.
        ...
        function exportarlistado(){
            var url = "../controladores/controladorExportar.php"; // the script where you handle the form input.
            $.ajax({
                type: "POST",
                url: url,
                data: $("#formulariomodificar").serialize(), // serializes the form's elements.
			...
			ul#icons span.ui-icon {float: left; margin: 0 4px;}*/
                ...
                <div id="contenido" style=" margin-left:250px;height: 390px;margin-top: -400px;width: 700px;">
                    ...
                    <form id="formulariomodificar" name="form" method="post" onsubmit="return validarDatosModificarComponente()" >
                        <strong style="color: black;font-size:12px;margin-left: -50px">Consultar Activos</strong>
                       ...
                       <div id='iddiv' style='margin-top:-40px;margin-left: -50px;'><strong><p style='font-size:12px'>Lista de activos</p></strong></div>
                        ...
                        <div  id="marcacomponente0" style="margin-left: -50px;margin-top: 0px;overflow-y: scroll;height: 275px;width: 122.5%"></div>
<!--                        <strong><?php
                                    $letrero = $_SESSION['tipoconsultados'];

                                    echo "$letrero";
                                    ?></strong>
                                                            <strong id="cantidadseleccionados"></strong>-->


                                    <!--                        <input style="margin-left: 700px" type="button" value="Imprimir">-->

                                </form>
<!--                                <div id='iddiv' style="margin-left: 565px;width: 300px;margin-top: 9px">
                                    <strong><a onclick="imprimirtotal()" id='imprimirtotal'style='margin-left:10px 'href='#'><img src='/images/imprimir.jpg' alt='' width='15px' height='15px'/>Imprimir total</a></strong>
                                    <strong><a onclick="imprimirlistado('contenidoo')" id='imprimirtotaltipo'style='margin-left:10px 'href='#'><img src='/images/imprimir.jpg' alt='' width='15px' height='15px'/>Imprimir listado</a></strong>
                                    <strong><a onclick="exportarlistado()" id='imprimirtotalmarca'style='margin-left:10px 'href='#'><img src='/images/exportar.jpg' alt='' width='15px' height='15px'/>Exportar listado</a></strong>
                                    <strong><a onclick="imprimirtotaldepartamento()" id='imprimirtotaldepartamento'style='margin-left:10px 'href='#'><img src='/images/imprimir.jpg' alt='' width='15px' height='15px'/>Imprimir total por departamento</a></strong>
                                    <strong><a onclick="imprimirtotalestado()" id='imprimirtotalestado'style='margin-left:10px 'href='#'><img src='/images/imprimir.jpg' alt='' width='15px' height='15px'/>Imprimir total por estado</a></strong>

                                </div>-->
                            </div>

                            <div id="contenidoo" style="overflow: scroll;height: 360px;width:110%;margin-left: 45%;margin-top: -360px;visibility: hidden">
                                <img src="/images/logo.jpg" alt="" width="320" height="74" />
                                <div style="margin-top: -10px;">________________________________________________________________________________________</div>

                                <!--                        <h2 style="margin-left:  250px;width: 300px;">Acta de Prueba</h2>-->


                                <div style="margin-top: 20px;width: 100%">
                                    <strong style="font-size: 20px;width: 100%">Listado de componentes: <?php
                                    $tipoimprimir = $_SESSION['imprimirtipoo'];
                                    $marcaimprimir = $_SESSION['imprimirmarcaa'];
                                    $estadoimprimir = $_SESSION['imprimirestadoo'];
                                    $departamentoimprimir = $_SESSION['imprimirdepartamentoo'];
                                    if ($tipoimprimir != 'Seleccionar') {
                                        echo $tipoimprimir;
                                    }
                                    if ($marcaimprimir != 'Seleccionar') {
                                        echo $marcaimprimir;
                                    }
                                    if ($departamentoimprimir != 'Seleccionar') {
                                        echo $departamentoimprimir;
                                    }
                                    if ($estadoimprimir != 'Seleccionar') {
                                        echo $estadoimprimir;
                                    }
                                    ?> </strong>
                        <?php
                                    if ($_SESSION['estacion'] != NULL) {
                                        $esta = utf8_decode($_SESSION['estacion']);
                                        $esta = explode("Estacion:", $esta);
                                        $esta = explode("Ubicacion:", $esta[1]);
                                        echo "<p>Estaci&oacute;n: $esta[0]</p>";
                                    }
                        ?>
                                    <table  border="0" style="width:100%;height: 10px;margin-top: 10px" >


                                        <tr>
                                            <td style="width: 10%"><strong style="font-size: 18px">Tipo</strong></td>
                                            <td style="width: 10%"><strong style="font-size: 18px">Marca</strong></td>
                                            <td style="width: 10%"><strong style="font-size: 18px">Modelo</strong></td>
                                            <td style="width: 10%"><strong style="font-size: 18px">Num serie</strong></td>
                                            <td style="width: 10%"><strong style="font-size: 18px">Num inventario</strong></td>
                                            <td style="width: 10%"><strong style="font-size: 18px">Estado</strong></td>
                                        </tr>
                            ...
                            <?php
                                    ...
                                    if ($_SESSION['estacion'] == NULL) {
                                        ...
                                        foreach ($mostrar as $i) {
                                            ...
                                            if (array_key_exists(1, $departamento)) {
                                                if ($departamento[1] == $_SESSION['depaselecc']) {
                                                    ...
                                                    if ($tipo == $tipoimprimir)
                                                        echo "<tr style='marginTop:-10px'><td>$tipo</td><td>$marca</td><td>$i->modelo</td><td>$i->numserie</td><td>$i->numeroinventario</td><td>$estado</td></tr>";
                                        ...
                                        $var = 0;
                                        foreach ($mostrar as $i) {
                                            if ($_SESSION['estacion'] == $i->estacion) {
                                                $tipo = utf8_decode($i->tipo);
                                                $marca = utf8_decode($i->marca);
                                                $estado = utf8_decode($i->estado);
                                                echo "<tr style='marginTop:-10px'><td>$tipo</td><td>$marca</td><td>$i->modelo</td><td>$i->numserie</td><td>$i->numeroinventario</td><td>$estado</td></tr>";
...
//                                        $contador = 0;
//                                        for ($iiii = 0; $iiii < count($arreglo2); $iiii++) {
//                                            for ($iii = 0; $iii < count($arreglo1); $iii++) {
//
//
//                                                if ($arreglo1[$iii] != $arreglo2[$iiii]) {
//                                                    $iiii = $iiii + 1;
//                                                    $arreglo2[$iiii] = $arreglo1[$iii];
//                                                }
//                                            }
//                                        }
//                                        for ($e = 0; $e < count($arreglo2); $e++) {
//                                            for ($r = 0; $r < count($arreglo1); $r++) {
//                                                if ($arreglo2[$e] == $arreglo1[$r]) {
//                                                    $contador++;
//                                                }
//                                            }
//                                            $arreglo3[$e] = $contador;
//                                            $contador = 0;
//                                        }
//                                        for ($t = 0; $t < count($arreglo2); $t++) {
//
//                                            echo "<strong>Cantidad de $arreglo2[$t]:</strong> $arreglo3[$t]<br>";
//                                        }
//                                        $suma = 0;
//                                        for ($t = 0; $t < count($arreglo2); $t++) {
//                                            $suma = $suma + $arreglo3[$t];
//                                        }
//
//                                        echo "Cantidad total de activos: $suma<br>";
//                                    } else {
//                                        $ii = 0;
//                                        $var = 0;
//                                        foreach ($mostrar as $i) {
...
//                                    }
                    ...
                    <div style="width: 300px;margin-top: 60px;margin-left: 70px">
                        <div>__________________________

                        </div>
                        <div>Nombre y firma del que entrega</div>
                        <div style="margin-left:350px;margin-top: -38px;">
                            ________________________
                            <div style="width: 200px;">  Nombre y firma del que recibe</div>
                        </div>
                ...
                <!--
                                       <div id="contenidoo" style="overflow: scroll; margin-left:400px;height: 370px;margin-top: -400px;width: 700px;visibility: hidden">
                 <div id='iddiv' style='margin-top:-40px;margin-left: 0px;'><strong><p style='font-size:12px'>Lista de activos</p></strong></div>
                                        <table width='840px' border='1' style=' border: 1px solid #000;
                                               border-collapse: collapse;
                                               padding: 0.3em;
                                        ...
                                        <div  id="marcacomponente00" style="margin-left: 0px;margin-top: 0px;overflow-y: scroll;height: 275px;width: 122.5%"></div>
                                </div>-->
