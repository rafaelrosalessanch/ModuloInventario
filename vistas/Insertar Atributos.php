...
return obj;
        ...
        <div>
			...
			ul#icons span.ui-icon {float: left; margin: 0 4px;}*/
                ...
                <div id="contenido" style="height: 59.6%;margin-top: -400px;">
                    
                    <form style="margin-left: 190px" id="formadicionaratrib" name="formadicionaratrib" onsubmit="return validarAdicionarAtributos()"  >
                            ...
                            <div style="margin-top: -22px;margin-left: 220px"><input type="button" name="registrarestado" value="Registrar" onclick="validarAdicionarAtributos()"/>
                                    </div>
                             <div style="margin-top: -24px;margin-left: 310px"><input type="button" name="eliminaratributos" value="Eliminar" onclick="eliminarAtributos()"/>
                                    </div>
                            <div style="margin-top: -24px;margin-left: 393px"><input type="reset" name="resetear" value="Resetear"  /></div>
                            ...
                            <div style="visibility:visible;margin-top: 10px;margin-left: 60px" id="atributosMarca" >
                                  <div style="width: 100%">
...
<!--                                    <table  width="150px" border="2" style=" border: 1px solid #000;
                                    ...
                                    <div id="aca" style='overflow-y: scroll;height: 300px;width: 15%;border-color: black;border-right-color: black' >
                                        <?php
...
<div style="margin-top: -345px;margin-left: 145px;width: 100%">
...
?>
 ...
 <div style="margin-top: -345px;margin-left: 290px;width: 100%">
                                     <table id="tablatipo" width="15%" border="2" style=" border: 1px solid #000;
                                   border-collapse: collapse;
                                   padding: 0.3em;
                                   caption-side: bottom">
...
?>
                                ...
                                <div id="divatributospc" style="margin-top: -165px;margin-left: -49.1%;visibility: hidden">

                                    <div style="margin-top: -345px;margin-left: 404px;">
...
?>
                                    ...
                                    <div style="margin-top: -345px;margin-left: 545px;width: 100%">
...
<!--                                    <table  width="150px" border="2" style=" border: 1px solid #000;
                                  ...
                                  <div>
                                   <table  width="150px" border="2" style=" border: 1px solid #000;
                                    ...
                                    <div id="aca" style='overflow-y: scroll;height: 300px;width: 10%;border-color: black;border-right-color: black' >
<?php
                                        $objregistrarrr = new ModeloLog();
...
?>
                                        <div id="todaslasmarcasdecomponentes"></div>
                                          ...
                                          <div style="margin-top: -345px;margin-left: 685px;width: 100%">
...
?>
                                    ...
                                    <div style="margin-top: -345px;margin-left: 825px;width: 100%">
...
?>
                                     ...
                                     <div style="margin-top: -345px;margin-left: 965px;width: 100%">
...
?>
                                     ...
                                     <div style="margin-top: -345px;margin-left: 1105px;width: 100%">
