...
oXML.send('');
                     ...
                     var url = "../controladores/controladorMostrarVicedirecciones.php"; // the script where you handle the form input.
                    $.ajax({
                        type: "POST",
                        url: url,
...
return obj;
 ...
 <div id="accordion" style="width: 180px; margin-top: -12px;">
                 ...
                 <div id="contenido" style=" margin-left:200px;height: 370px;margin-top: -378px;width: 500px;">

                    <form id="form_lo" name="form" onsubmit="return validarinsertarusuario()"  method="post">
                        <strong style="color: black;font-size:12px">Gestionar Vicedireccion</strong>
                        ...
                        <strong style="margin-top: 10px">Vicedirecciones insertadas</strong>
                        <table width='400px' border='1' style=' border: 1px solid #000;
...
<td style='width: 10px'><strong><p style='font-size:12px;color:white;width: 39.5px'>Seleccionar</p></strong></td>
                        ...
                        <div  id="marcacomponente0" style="overflow-y: scroll;height: 243px;width: 83.5%"></div>

                        <div id="divinsertaruser" style="margin-top: 15px;width: 850px;">
                                    <div id="error" style="margin-top: 0px;">
                            <strong style="color: red;margin-left: 0px;">Atributo de la vicedirecci&oacute;n ha insertar o modificar</strong>


                        </div>
                            <strong style="font-size:11px;">Nombre: </strong><input type="text" name="nombredepartamento" id="nombredepartamento" style="width:120px;"/>
