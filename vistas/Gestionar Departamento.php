...
<head>
    ...
    <script language="javascript" type="text/javascript">
        window.onload = function() {
            document.onkeyup = muestraInformacionn;
            document.onkeypress = muestraInformacionn;
            document.onkeydown = muestraInformacionn;
...
oXML.send('');
                     ...
                     var url = "../controladores/controladorMostrarDepa_1.php"; // the script where you handle the form input.
                    $.ajax({
                        type: "POST",
                        url: url,
   ...
   $("#modificaruser").click(function(){
                   var url = "../controladores/controladorModificarDepa.php"; // the script where you handle the form input.
                $.ajax({
                    type: "POST",
                    url: url,
...
// document.getElementById('fil').style.visibility='hidden';
 ...
 $("#agregaruser").click(function(){
             ...
             var url = "../controladores/controladorDepartamento.php"; // the script where you handle the form input.
            $.ajax({
                type: "POST",
                url: url,
                data: $("#form_lo").serialize(), // serializes the form's elements.
 ...
 setTimeout("areas()",1);
                setTimeout("ubicacionnuevadepa()",1);
           setTimeout("actualizar()",1000);
            setTimeout("borrar()",3000);
...
// document.getElementById('fil').style.visibility='hidden';
    ...
    function mostrar(){
     var url = "../controladores/controladorMostrarDepa_2.php"; // the script where you handle the form input.
                $.ajax({
                    type: "POST",
                    url: url,
                    data: $("#form_lo").serialize(), // serializes the form's elements.
                    success: function(data)
                    {
                        $("#depa").html(data); // show response from the php script.
                    }
    ...
    document.getElementById('fil').style.visibility='hidden';
                    ...
                    function EliminarDepartamentoo(){



                  
                      var url = "../controladores/controladorEliminarDepartamento_1.php"; // the script where you handle the form input.
            $.ajax({
                type: "POST",
                url: url,
                data: $("#form_lo").serialize(), // serializes the form's elements.
...
//      document.getElementById('depa').style.visibility='hidden';
        ...
        function muestraInformacionn(elEvento) {
            var eventoo = window.event || elEvento;

            var aas=eventoo.keyCode;
...
//   document.getElementById("nombredepartamento").style.backgroundColor="white";
...
//                document.getElementById("nombredepartamento").style.backgroundColor="red";
//                return false;
//            }
        }
        function validarDatosDepartamento(){
...
<body>
    ...
    <div class="content" style="width: 1050px" >
        ...
        <div class="header" id="header">
            <p style='color:red;margin-left: 450px;visibility: hidden' id='mensajeee'><img src='/images/incorrecto.jpg' alt='' width='17' height='17' /><strong>Seleccione un departamento a  modificar </strong></p>
        ...
        <div>
			...
			ul#icons span.ui-icon {float: left; margin: 0 4px;}*/
                ...
                <div style="width: 20px">
                 ...
                 <div id="contenido" style=" margin-left:200px;height: 370px;margin-top: -400px;width: 500px;">

                    <form id="form_lo" name="form" onsubmit="return validarinsertarusuario()"  method="post">
                        <strong style="color: black;font-size:12px">Gestionar Departamento</strong>
                        ...
                        <strong style="margin-top: 10px">Departamentos insertados</strong>
                        <table width='840px' border='1' style=' border: 1px solid #000;
                               border-collapse: collapse;
                               padding: 0.3em;
                               caption-side: bottom;'>
                            <tr style='background-image: url(/images/fondo.png)'>
<td style='width: 10px'><strong><p style='font-size:12px;color:white;width: 39.5px'>Seleccionar</p></strong></td>
                                <td style='width: 149px'><strong><p style='font-size:12px;color:white'>Nombre</p></strong></td>
                                <td style='width: 74px'><strong><p style='font-size:12px;color:white'>Ubicacion</p></strong></td>
                                <td style='width:144px'><strong><p style='font-size:12px;color:white'>Vicedireccion</p></strong></td>
                        ...
                        <div  id="marcacomponente0" style="overflow-y: scroll;height: 243px;width: 171.5%"></div>
                            
                        <div id="divinsertaruser" style="margin-top: 15px;width: 850px;">
                                    <div id="error" style="margin-top: 0px;">
                            <strong style="color: red;margin-left: 0px;">Atributos del departamento ha insertar o modificar</strong>


                        </div>
                            <strong style="font-size:11px;">Nombre: </strong><input type="text" name="nombredepartamento" id="nombredepartamento" style="width:120px;" onkeypress="return isstringKeyy()"/>
                            <strong style="font-size:11px;margin-left: 5px">Ubicacion:</strong>
                         <select id="ubicaciondepartamento" name="ubicaciondepartamento" style="width: 20%;">
...
?>
                        ...
                        <strong style="font-size:11px;margin-left: 5px">Vicedireccion:</strong>
                         <select id="opcionesareadepartamento" name="opcionesareadepartamento" style="width: 20%;">
...
<!--                        <input style="margin-left: 10px" type="button" name="registrar" value="Registrar" onclick="return validarinsertarusuario()"/>-->
                        ...
                        <div id='iddiv' style="margin-left: 620px;width: 250px;margin-top: 10px"><strong><a id='agregaruser'style='margin-left:10px 'href='#'><img src='/images/agregar.jpg' alt='' width='15px' height='15px'/>Agregar</a></strong><strong style='font-size:12px;margin-top: 10px'><td style='width: 10px'><a id='eliminaruser'onclick="EliminarDepartamentoo()" style='margin-left:15px 'href='#'><img src='/images/eliminar.jpg' alt='' width='15px' height='15px'/>Eliminar</a><a id="modificaruser" style='margin-left:10px 'href='#'><img src='/images/modificar.jpg' alt='' width='15px' height='15px' />Modificar</a></td></strong>
