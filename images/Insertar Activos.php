        ...
        $(document).ready(function(){
            ...
            $("#asignardesdealmacen").click(function(){
                ...
                if(document.getElementById("tipocomponenteregistrar").value=="Seleccionar"){
                    ...
                    document.getElementById("contenido").style.height='56.2%';
            ...
            $("#tipocomponenteregistrar").click(function(){
                if(document.getElementById("tipocomponenteregistrar").value=="Computadora"){
                    ...
                    document.getElementById("contenido").style.height='106%';
...
<body>
    <div class="content" style="width: 1050px" >
        ...
        <h3 style="width: 80%">  <div style="margin-left: 95%;">
                ...
                <h5 style="margin-top: -15px"><?php echo $_SESSION['palabra']; ?><a style="margin-top: -33px;margin-left: 10px;" href="../vistas/Nueva%20carpeta/index.php" >Salir</a><a style="margin-top: -33px;margin-left: 10px;" href="../vistas/cambiar_contrasena.php" >Cambiar_contrase&ntilde;a</a></h5>
            </div></h3>
        <style TYPE="text/css">
        ...
        <div style="width: 100%">
            <ul id="menu" >
                <li ><a href="informatica.php"style="color: white">Home</a></li>
                <li class="active"> <a href="Gestionar Departamento.php"style="color: white">Gestionar Objetos</a>
                </li>

                <li ><a href="areasAdministrativas.php" style="color: white">Reportes</a>
                </li>

                <li ><a href="Insertar Usuario.php"style="color: white">Administraci&oacute;n</a></li>
        ...
        <div>
			...
			ul#icons span.ui-icon {float: left; margin: 0 4px;}*/
                    ...
                    <div id="accordion" style="width: 180px; margin-top: -12px;">
                        ...
                        <div class="right_articles" >
                            <ul id="enlaces">
                                ...
                                $obj = new ModeloLog();
                                $mostrar = $obj->mostrar_acordion();
                                foreach ($mostrar as $i) {
                                    $nombre = utf8_decode($i->nombrelinkobjetos);
                                    if ($nombre != null) {
                                        $link = $i->linkobjetos;

                                        echo "  <div style='margin-top: 10px'>
                                    <a href='$nombre.php' style='margin-top: 1px;height: 50px;margin-left: -15px'>$nombre</a>
                                ...
                                <!--                                <div style="margin-top: 10px"><a  href="informaticaRegistrarEstacion.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Insertar Estaci&oacute;n</a>
                                                                </div>
                                                                <div style="margin-top: 10px"><a  href="informaticaRegistrarComponente.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Insertar Activos</a>
                                                                </div>
                                                                                                <div style="margin-top: 10px"><a  href="modificarDepartamento.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Modificar Departamento</a>
                                                                                                </div>
                                                                                                <div style="margin-top: 10px"><a  href="modificarEstacion.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Modificar Estacion</a>
                                                                                                </div>
                                                                <div style="margin-top: 10px"><a  href="modificarDepartamento.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Modificar Departamento</a>
                                                                </div>
                                                                <div style="margin-top: 10px"><a  href="modificarEstacion.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Modificar Estaci&oacute;n</a>
                                                                </div>
                                                                <div style="margin-top: 10px"><a  href="modificarComponente.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Modificar Activos</a>
                                                                </div>
                                                                <div style="margin-top: 10px"><a  href="eliminarDepartamento.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Eliminar Departamento</a>
                                                                </div>
                                                                <div style="margin-top: 10px"><a  href="eliminarEstacion.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Eliminar Estaci&oacute;n</a>
                                                                </div>
                                                                <div style="margin-top: 10px"><a  href="expedienteTecnico.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Expediente T&eacute;cnico</a>
                                                                </div>-->
                                <!--                                <div style="margin-top: 10px"><a  href="eliminarComponente.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Eliminar Componente</a>
                                                                </div>-->
                            </ul>
                        ...
                        <div class="right_articles" >
                            <ul id="enlaces">
                                <?php
                                include_once '../modelo/ModeloLog.php';
                                $objatrib = new ModeloLog();
                                $mostraratrib = $objatrib->mostrar_acordion();
                                foreach ($mostraratrib as $iatrib) {
                                    $nombreatrib = utf8_decode($iatrib->nombrelinkatributos);
                                    if ($nombreatrib != null) {
                                        $link = $i->linkobjetos;
                                        echo "  <div style='margin-top: 10px'>
                                    <a href='$nombreatrib.php' style='margin-top: 1px;height: 50px;margin-left: -15px'>$nombreatrib</a>

                                </div>";
                                    }
                                }
                                ?>
                                <!--                                <div style="margin-top: 10px"><a  href="registrarAtributos.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Insertar Atributos</a>
                                                                </div>
                                                                                                  <div style="margin-top: 10px"><a  href="eliminarAtributos.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Eliminar Atributos</a>
                                                                                                </div>
                                                                <div style="margin-top: 10px"><a  href="vincularAtributos.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Asignar Atributos</a>
                                                                </div>
                                                                <div style="margin-top: 10px"><a  href="eliminarAtributos.php" style="margin-top: 10px;height: 50px;margin-left: -15px">Eliminar Atributos</a>
                                                                </div>-->
                            </ul>
                        ...
                        <div class="right_articles" >
                            <ul id="enlaces">
                                ...
                                $mostraratrib = $objatrib->mostrar_acordion();
                                foreach ($mostraratrib as $iatrib) {
                                    $nombreatrib = utf8_decode($iatrib->nombrelinkconsultas);
                                    if ($nombreatrib != null) {
                                        $link = $i->linkobjetos;
                                        echo "  <div style='margin-top: 10px'>
                                    <a href='$nombreatrib.php' style='margin-top: 1px;height: 50px;margin-left: -15px'>$nombreatrib</a>
                ...
                <div id="contenido" style=" margin-left:250px;height: 56.2%;margin-top: -400px;width: 100%;">
<!--                    <div style="margin-top: -10px;margin-left: 200px;width: 100%">
                    ...
                    <form style="visibility: visible;margin-top: 10px;margin-left: -40px ;width: 830px" id="formularioregistrar" name="formularioregistrar" method="post" onsubmit="return valir();">
...
<!--                               <strong  style="width: 150px;margin-top: 5px"><strong style="font-size:12px">Observaciones:</strong>
     <input type="" name="observacionescomponentes" id="observaciones" placeholder="Campo no obligatorio" style="width: 40%;height: 80%"/>
                                            ...
                                            <div id="divasignar" style="margin-top: -30%">
                                            ...
                                            <div id="estacionesfila1" style="width:99.5%;margin-top: 5px">
                                                <strong>Estaciones de trabajos:</strong>
                                                <table> <tr style='background-image: url(/images/fondo.png);'>
                                            ...
                                            <div id="estaciones" style="overflow-y:scroll;height: 140px;width:101%;margin-left: 1.5px;margin-top: -2px"></div>


                                            <td style="border-color: white">&nbsp;</td>
                                            <td style="border-color: white"><input type="button" id="registrarcomponente" name="registrarcomponente" value="Registrar" style="margin-left: 78%;margin-top: 10px" onclick="valir()"/>
                                                <input type="reset" name="resetear" id="resetear" value="Resetear"  /></td>
