                    ...
                    <form id="formulariomodificar" name="form" method="post" onsubmit="return validarDatosModificarComponente()" >
                        ...
                        <div style="margin-left: -50px">
                          <input style="margin-left: 0px;" type="checkbox" id="activarfiltro"><strong>Activar o desactivar filtro</strong>
                            ...
                            <fieldset id="fieldsetfiltro" style="margin-left: 0px;width: 97%;visibility: hidden"><legend>
                                Filtrar por:
                            </legend>
                                                    <div>
                                                        <strong>Tipo:</strong>
...
<!--                                                </fieldset>-->
 <div style="margin-left: 735px;margin-top: -20px;width: 100px">
     ...
     <input style="margin-top: -20px;width: 100px" type="text" name="buttonfiltrarpornuminventario" id="buttonfiltrarpornuminventario" onkeypress="return isstringKeyy()" >
     ...
     <select name="marcamodificar" id="marcamodificar"  style="width: 140px;margin-top: 0px;visibility: hidden">
                        ...
                        <div id='iddiv' style="margin-left: 718px;margin-top: -3px"><strong style='font-size:12px;margin-top: 10px'><td style='width: 144px'><a id="modificaruser" onclick="validarDatosModificarComponente()" style='margin-left:10px 'href='#'><img src='/images/modificar.jpg' alt='' width='15px' height='15px' />Modificar</a></td></strong>
