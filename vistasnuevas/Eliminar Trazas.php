...
oXML.send('');
            ...
            var url = "../controladores/controladorTrazas_1.php"; // the script where you handle the form input.
            $.ajax({
                type: "POST",
                url: url,
...
if (document.getElementById('activarfiltro').checked){
    ...
    document.getElementById("marcacomponente0").style.height="215px";
 ...
 document.getElementById('iddiv').style.marginTop='10px';
           ...
           document.getElementById("marcacomponentemodificar").value="Seleccionar";
                    ...
                    document.getElementById("marcacomponente0").style.height="285px";
                    document.getElementById('iddiv').style.marginTop='-60px';
document.getElementById('todoscheckbox').checked=0;
...
function trazas(){
 if (!confirm("Esta seguro que quiere eliminar la(s) traza(s) seleccionada(s)")){
     return false;
...
<div id="accordion" style="width: 180px; margin-top: -12px;">
                ...
                <div id="contenido" style=" margin-left:250px;height: 390px;margin-top: -300px;width: 900px;">

                    <form id="formulariomodificar" name="formulariomodificar" style="width: 700px" action="../controladores/controladorEliminarTrazasTxt.php" method="post" onsubmit="return trazas()">
...
<strong>Departamento:</strong>
                        ...
                        <table width='840px' border='1' style=' border: 1px solid #000;
                            ...
                            <tr style='background-image: url(/images/fondo.png)'>
                                <td style='width: 10px'><input type="checkbox" id="todoscheckbox"></td>
                        ...
                        <div  id="marcacomponente0" style="margin-left: -50px;margin-top: 0px;overflow-y: scroll;height: 285px;width: 122.5%"></div>
...
<!--                        <div id='iddiv' style="margin-left: 694px;width: 200px;margin-top: 7px"><strong><a onclick="eliminartraza()" id='registrarcomponenteasignar'style='margin-left:10px 'href='#'><img src='/images/eliminar.jpg' alt='' width='15px' height='15px'/>Eliminar Traza</a></strong>
                        ...
                        <div style="margin-left: 725px;width: 200px" onmouseover='this.style.cursor = "hand"' >
                        <strong onmouseover='this.style.cursor = "hand"'> <img style="" src='/images/eliminar.jpg' alt='' width='15px' height='15px'/><a href="#" onmouseover='this.style.cursor = "hand"' ><input onmouseover='this.style.cursor = "hand"' type="submit" value="Eliminar" style=" font: normal 12px Verdana, Arial, Helvetica, sans-serif;
	color: blue;
	margin-left: -1px;
        width: 60px;
	border: white;
