...
if (!confirm("Esta Seguro que desea eliminar el activo")){
                history.go(0);
               ...
               var url = "../controladores/controladorEliminarComponente.php"; // the script where you handle the form input.
                $.ajax({
                    type: "POST",
                    url: url,
                    data: $("#formulariomodificar").serialize(), // serializes the form's elements.
...
setTimeout("actcualizarmodificaractivo()",1);
        ...
        function isstringKeyy(){
            if(document.getElementById('buttonfiltrarpornuminventario').value==''||document.getElementById('buttonfiltrarpornuminventario').value.length==1){
                ...
                var url = "../controladores/controladorModificarComponenteinventarioo.php"; // the script where you handle the form input.
                $.ajax({
                    type: "POST",
                    url: url,
                    data: $("#formulariomodificar").serialize(), // serializes the form's elements.
...
<script>
			...
			ul#icons span.ui-icon {float: left; margin: 0 4px;}*/
                ...
                <div id="contenido" style=" margin-left:250px;height: 390px;margin-top: -400px;width: 800px;">

                    <form id="formulariomodificar" name="form" method="post" onsubmit="return validarDatosModificarComponente()" >
                        <strong style="color: black;font-size:12px;margin-left: -50px">Modificar Activo</strong>
                        ...
                        <div style="margin-left: -50px">
                          <input style="margin-left: 0px;" type="checkbox" id="activarfiltro"><strong>Activar o desactivar filtro</strong>
                            ...
                            <fieldset id="fieldsetfiltro" style="margin-left: 0px;width: 97%;"><legend>
                                Filtrar por:
                            </legend>
                                                    <div>
                                                        <strong>Tipo:</strong>
                                                        ...
                                                        <select name="tipocomponenteregistrar" id="tipocomponenteregistrar"  style="width: 12%;margin-top: 0px">
                                                    ...
                                                    <div id="divmarca" style="margin-left: 140px;margin-top: -20px">
                                                        <strong>Marca:</strong>

                                                        <select name="marcacomponentemodificar" id="marcacomponentemodificar"  style="width: 15%;margin-top: 0px">
                                                            <option>Seleccionar</option>
                                                            <?php
                                                            include_once '../modelo/ModeloLog.php';
                                                            $extract = extract($_GET);
                                                    ...
                                                    <div id="divmarca" style="margin-left: 300px;margin-top: -20px">
                                                        <strong>Estado:</strong>


                                                        <select name="estadocomponenteregistrar" id="estadocomponenteregistrar"  style="width: 20%;margin-top: 0px">
                                                            <option>Seleccionar</option>
                                                            <?php
                                                            include_once '../modelo/ModeloLog.php';
                                                            $extract = extract($_GET);
                                                    ...
                                                    <div id="divmarca" style="margin-left: 465px;margin-top: -20px">
...
<!--                                                </fieldset>-->
 <div style="margin-left: 735px;margin-top: -20px;width: 100px">
     ...
     <input style="margin-top: -20px;width: 100px" type="text" name="buttonfiltrarpornuminventario" id="buttonfiltrarpornuminventario" onkeyup="return isstringKeyy()" >
                       ...
                       <div id='iddiv' style='margin-top:0px;margin-left: -50px;'><strong><p style='font-size:12px'>Lista de activos</p></strong></div>
                        ...
                        <div  id="marcacomponente0" style="margin-left: -50px;margin-top: 0px;overflow-y: scroll;height: 214px;width: 107%"></div>


                        <div id="error" style="margin-top: 15px;">
                            <strong style="color: red;margin-left: -50px;">Atributos a modificar</strong>


                        </div>
                        <div style="width: 800px">

                            <strong style="font-size: 12px;margin-left: -50px">Modelo:</strong>
                            <input type='text' name='modelomodificar'id='modelomodificar' style="margin-top: 10px; width: 80px"  />
                            <strong style="font-size: 12px;margin-left: 5px">Num de serie:</strong>
                            <input type='text' name='numseriemodificar'id='numseriemodificar' style="margin-top: 10px; width: 80px"  />
                            <strong style="font-size: 12px;margin-left: 5px">Num de inventario:</strong>
                            <input type='text' name='numinventariomodificar'id='numinventariomodificar' style="margin-top: 10px; width: 80px"  />
                            <strong style="font-size: 12px;margin-left: 5px">Estado:</strong>
                            <select name="estadomodificar" id="estadomodificar"  style="width: 80px;margin-top: 0px">
                                <option>Seleccionar</option>
                                <?php
                                            include_once '../modelo/ModeloLog.php';
                                            $extract = extract($_GET);
                            ...
                            <strong style="font-size: 12px;margin-left: 5px">Observaciones:</strong>
                            <input type='text' name='observacionsmodificar'id='observacionmodificar' style="margin-top: 10px; width: 80px"  />
                            <strong style="font-size: 12px;margin-left: -8px;visibility: hidden">Marca:</strong>
     <select name="marcamodificar" id="marcamodificar"  style="width: 140px;margin-top: 0px;visibility: hidden">
                                <option>Seleccionar</option>
                            </select>

                        </div>
                        <div id='iddiv' style="margin-left: 640px;margin-top: -3px"><strong style='font-size:12px;margin-top: 10px'><td style='width: 144px'><a id="modificaruser" onclick="validarDatosModificarComponente()" style='margin-left:10px 'href='#'><img src='/images/modificar.jpg' alt='' width='15px' height='15px' />Modificar</a><strong style='font-size:12px;margin-top: 10px'><td style='width: 10px'><a id='eliminaruser'onclick="EliminarActivos()" style='margin-left:15px 'href='#'><img src='/images/eliminar.jpg' alt='' width='15px' height='15px'/>Eliminar</a></td></strong>
